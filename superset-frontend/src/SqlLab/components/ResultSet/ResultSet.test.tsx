...
describe('ResultSet', () => {
  ...
  test('should call reRunQuery if error message starts with the timeout phrase', async () => {
    const query = {
      ...queries[0],
  ...
  test('should not call reRunQuery for a nonmatching error message', async () => {
    const query = {
      ...queries[0],
