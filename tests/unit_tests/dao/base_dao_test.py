...
def test_list_negative_page_uses_offset_zero():
    """A negative page is clamped so the SQL OFFSET is 0, matching page=0."""
...
def test_list_nonnegative_page_unchanged():
    ...
    mock_query = _list_with_page(3, page_size=50)

    mock_query.offset.assert_called_once_with(150)
